    ...
    public static void  get_Data(){
        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    URL url;
if(Constants.market_category.equals(""))
                     url=new URL("http://"+ Api.url+"get_shops1.php"); else
                         url=new URL("http://"+ Api.url+"get_shopsbycatAll.php");
                ...
                try{//bashda data basadan hemme informasiyasyny alyas
                 ...
                 shops m;
                    for(int i=0; i<jsonArray.length();i++){
                       ...
                       if(!Constants.shopses.contains(m)) Constants.shopses.add(m);
                    }
if(Constants.hb=="h"|| !Constants.market_category.equals(""))post_markets.s1.sendEmptyMessage(1); else
