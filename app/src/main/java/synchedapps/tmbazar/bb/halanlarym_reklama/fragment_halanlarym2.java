...
public class fragment_halanlarym2 extends Fragment{
    ...
    public fragment_halanlarym2() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment2_halanlarym, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recycle_for_halanlarym_realtor);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);
        db=new Db(MainActivity.ctx);
        data=new ArrayList<>();
        a = new adapter_for_recycle_for_realtor(data, getActivity(),"likedhome");
